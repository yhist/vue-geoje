...
export default {
  setup(){
    ...
    const galleryData = computed( () => store.getters.galleryData)
    const movieData = computed( () => store.getters.movieData)
    return{
      galleryData,
      movieData
    }
...
.gallery {
  ...
  background: url('@/assets/images/img_bottombg.jpg') no-repeat center;
